...
var data_1 = __webpack_require__(26);
ReactDOM.render(React.createElement(App_1.default, { width: window.screen.availWidth, height: window.screen.availHeight, data: data_1.default }), document.getElementById('app'));
...
var App = (function (_super) {
    ...
    App.prototype.componentDidMount = function () {
        ...
        var force = d3.layout.force()
            ...
            .nodes(data.nodes)
            .links(data.links);
        var svg = d3.select(this.ctrls.mountPoint)
            .append('svg')
            .attr('width', width)
            .attr('height', height);
